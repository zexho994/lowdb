...
public class BTreeFileDeleteTest extends SimpleDbTestBase {
    ...
    public void testRedistributeLeafPages() throws Exception {
        ...
        BTreeLeafPage rightSibling = (BTreeLeafPage) Database.getBufferPool().getPage(tid, rightSiblingId, Permissions.READ_ONLY);
    ...
    public void testMergeLeafPages() throws Exception {
        ...
        BTreeRootPtrPage rootPtr = (BTreeRootPtrPage) Database.getBufferPool().getPage(tid, rootPtrId, Permissions.READ_ONLY);
        BTreeInternalPage root = (BTreeInternalPage) Database.getBufferPool().getPage(tid, rootPtr.getRootId(), Permissions.READ_ONLY);
    ...
    public void testDeleteRootPage() throws Exception {
        ...
        BTreeLeafPage root = (BTreeLeafPage) Database.getBufferPool().getPage(tid, rootPtr.getRootId(), Permissions.READ_ONLY);
    ...
    public void testRedistributeInternalPages() throws Exception {
        ...
        BTreeRootPtrPage rootPtr = (BTreeRootPtrPage) Database.getBufferPool().getPage(tid, BTreeRootPtrPage.getId(bf.getId()), Permissions.READ_ONLY);
        BTreeInternalPage root = (BTreeInternalPage) Database.getBufferPool().getPage(tid, rootPtr.getRootId(), Permissions.READ_ONLY);
        assertEquals(502, root.getNumEmptySlots());

        BTreeEntry rootEntry = root.iterator().next();
        BTreeInternalPage leftChild = (BTreeInternalPage) Database.getBufferPool().getPage(tid, rootEntry.getLeftChild(), Permissions.READ_ONLY);
        BTreeInternalPage rightChild = (BTreeInternalPage) Database.getBufferPool().getPage(tid, rootEntry.getRightChild(), Permissions.READ_ONLY);
        ...
        while (it.hasNext() && count < 49 * 502 + 1) {
            BTreeLeafPage leaf = (BTreeLeafPage) Database.getBufferPool().getPage(tid, it.next().getLeftChild(), Permissions.READ_ONLY);
    ...
    public void testDeleteInternalPages() throws Exception {
        ...
        BTreeRootPtrPage rootPtr = (BTreeRootPtrPage) Database.getBufferPool().getPage(tid, BTreeRootPtrPage.getId(bigFile.getId()), Permissions.READ_ONLY);
        BTreeInternalPage root = (BTreeInternalPage) Database.getBufferPool().getPage(tid, rootPtr.getRootId(), Permissions.READ_ONLY);
        ...
        rightChild = (BTreeInternalPage) Database.getBufferPool().getPage(tid, e.getRightChild(), Permissions.READ_ONLY);
        assertEquals(0, leftChild.getNumEmptySlots());
